...
echo "Copying files"
copy /y %TEMPDIR%\PotPlayer64\ffcodec64.dll %TEMPDIR%\PotPlayer64\Module\FFmpeg61\ffcodec64.dll

echo "Renaming files"
move /y %TEMPDIR%\PotPlayer64\Module\FFmpeg61\ffcodec64.dll %TEMPDIR%\PotPlayer64\Module\FFmpeg61\FFmpeg64.dll
