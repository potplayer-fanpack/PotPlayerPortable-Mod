...
%BINDIR%\wget.exe https://t1.daumcdn.net/potplayer/PotPlayer/Codec/v5/OpenCodecSetup64.exe
...
move /y %TEMPDIR%\PotPlayer64\Module\FFmpeg62 %TEMPDIR%\PotPlayer64\Module\FFmpeg63
